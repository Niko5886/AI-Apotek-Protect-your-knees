    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
        <button
          type="button"
          onClick={onBack}
          className="flex items-center gap-2 rounded-full bg-neutral-900/90 px-5 py-2.5 text-sm text-neutral-300 backdrop-blur transition-colors hover:text-white"
        >
          <span aria-hidden="true">←</span> back
        </button>
        <div className="flex items-center gap-2">
          <img src="/logo.png" alt="vit4ever Skinesium" className="h-10 w-auto object-contain drop-shadow-lg" />
